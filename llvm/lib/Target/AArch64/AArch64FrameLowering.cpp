...
#include "AArch64AOS/AOSFrameLowering.h" //yh+
...
void AArch64FrameLowering::emitPrologue(MachineFunction &MF,
  ...
  //yh+
  //AOSFrameLowering::instrumentPrologue(TII, Subtarget.getRegisterInfo(), MBB, MBBI, DL);
...
void AArch64FrameLowering::emitEpilogue(MachineFunction &MF,
  ...
  //yh+
  //auto AOSCleanup = make_scope_exit([&] { AOSFrameLowering::instrumentEpilogue(TII, Subtarget.getRegisterInfo(), MBB); });
